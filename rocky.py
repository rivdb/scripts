...
# Prompt user about the restoration process
input(f"{Cols.YELLOW} [ Going to restore /etc/yum.repos.d/official-packages-repositories.repo and complete this ]")

# Read the new repository data from a correct sources file
sources_data = open("correct_sources.repo", 'r').read()

# Write the new repository data to the appropriate .repo file
with open('/etc/yum.repos.d/official-packages-repositories.repo', 'w') as f:
...
os.system('dnf install coreutils -y -qq')
# in case they messed or backdoored one of the coreutils
os.system('dnf reinstall coreutils')
...
print(f"{Cols.WHITE}")
os.system("dnf install ufw -y -qq")
...
if option == 'n':
    print(f"{Cols.WHITE}")
    os.system("dnf remove samba -y -qq")
    os.system("dnf remove samba-common -y  -qq")
    os.system("dnf remove samba-common-bin -y -qq")
...
if option == "n":
    ...
    print(f"{Cols.WHITE}")
    os.system("dnf remove vsftpd -y -qq")
...
if option == "y":
    ...
    print(f"{Cols.WHITE}")
    os.system("dnf remove openssh-server -y -qq")
...
print(f"{Cols.WHITE}")
os.system("dnf install libpam-cracklib -y -qq")
...
print(f"{Cols.WHITE}")
os.system('dnf install iptables -y -qq')
...
os.system("dnf install apparmor-profiles -y -qq")

# AV stuff:
print(f"{Cols.YELLOW}[ Setting up ClamAV... ]")
os.system("dnf install clamav -y -qq")
os.system("dnf install clamav-daemon -y -qq")
print(f'''{Cols.YELLOW} 
...
os.system(f"dnf install rkhunter -y -qq")
print(f'''{Cols.YELLOW} 
      [*] - I have just installed ClamAV for you, 
...
print(f"{Cols.WHITE}")
os.system("dnf install debsums -y -qq")
